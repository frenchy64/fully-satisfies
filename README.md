...
[Current version API documentation](https://frenchy64.github.io/fully-satisfies/1.10.3)
...
```clojure
[io.github.frenchy64/fully-satisfies "1.10.3"]
```
...
```clojure
  ...
  :deps {io.github.frenchy64/fully-satisfies 
         {:git/tag "1.10.3", :git/sha "2688738"}}
```
...
```clojure
# compile
clj -Sdeps '{:deps {io.github.frenchy64/fully-satisfies {:git/tag "1.10.3", :git/sha "2688738"}}}' -X:deps prep
# start REPL
clj -Sdeps '{:deps {io.github.frenchy64/fully-satisfies {:git/tag "1.10.3", :git/sha "2688738"}}}'
```
