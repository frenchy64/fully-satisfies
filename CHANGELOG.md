...
- Add `io.github.frenchy64.fully-satisfies.linear-expansion` for macro whose expansions grow linearly rather than exponentially
  - contains versions of `clojure.core/{for,doseq}`
