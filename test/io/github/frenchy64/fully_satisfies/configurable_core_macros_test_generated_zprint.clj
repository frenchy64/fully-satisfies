...
(ns
  ...
  ^{:line 112, :column 39} (:refer-clojure :only [])
  (:require
    [clojure.core :as cc]
...
(clojure.core/defmacro my-let
  ...
  {:forms (quote [^{:line 37, :column 60} (let [bindings*] exprs*)])}
...
(clojure.core/defmacro my-fn
  ...
  {:forms (quote [^{:line 102, :column 18} (fn name? [params*] exprs*)
                  ^{:line 102, :column 47}
    ...
    :arglists (quote ^{:line 107, :column 37}
                     ([name doc-string? attr-map? [params*] prepost-map? body]
                      [name doc-string? attr-map?
                       ...
                       attr-map?]))}
  my-defn
  (clojure.core/fn my-defn [&form__2192__auto__ &env__2193__auto__
                            name__2194__auto__ & fdecl__2195__auto__]
